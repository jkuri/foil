...
export function ColorInput({ value = "#000000", opacity = 1, onChange, className, isMixed = false }: ColorInputProps) {
  const displayValue = isMixed ? "Mixed" : value ? value.toUpperCase() : "";
